...
#define SOF_RT1015_SPEAKER_AMP_100FS		BIT(16)
#define SOF_RT1015P_SPEAKER_AMP_PRESENT		BIT(17)
#define SOF_MAX98373_SPEAKER_AMP_PRESENT	BIT(18)
#define SOF_MAX98360A_SPEAKER_AMP_PRESENT	BIT(19)
...
static const struct dmi_system_id sof_rt5682_quirk_table[] = {
	...
	},
	{
		...
		.matches = {
			...
			DMI_MATCH(DMI_OEM_STRING, "MAX98390_ALC5682I_I2S"),
		},
		.driver_data = (void *)(SOF_RT5682_MCLK_EN |
					SOF_RT5682_SSP_CODEC(0) |
					SOF_SPEAKER_AMP_PRESENT |
...
static int sof_rt5682_codec_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	if ((sof_rt5682_quirk & SOF_RT5682_MCLK_EN) &&
		...
		if (sof_rt5682_quirk & SOF_RT5682S_HEADPHONE_CODEC_PRESENT)
			rt5682s_sel_asrc_clk_src(component, RT5682S_DA_STEREO1_FILTER |
